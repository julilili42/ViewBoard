...
sealed class Screen(val route: String) {
    ...
    object ViewIssueScreen : Screen("viewIssue/{viewName}/{viewID}/{projID}"){
        fun createRoute(viewName: String, viewID: String, projID: String) = "viewIssue/$viewName/$viewID/$projID"
    }
}